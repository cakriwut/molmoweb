...
class PointTrajectoryEntry(TypedDict):
    ...
    points: Dict[str, _Point]  # object_id -> {'point': [x, y], 'occluded': bool}
...
class UnifiedPointFormatter(PointFormatter):
    ...
    def _filter_initial_point(self, frames_data: List[PointTrajectoryEntry]) -> List[PointTrajectoryEntry]:
        filtered = []
    ...
    def _filter_for_initial_points(self, frames_data: List[PointTrajectoryEntry], initial_points) -> List[PointTrajectoryEntry]:
        """
